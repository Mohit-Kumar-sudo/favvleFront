...
class RankCreation extends React.Component {
	...
	componentDidMount() {
		window.scrollTo(0, 0);
		this.setState({
			_id: localStorage?.getItem("idLibrary")?JSON.parse(localStorage.getItem("idLibrary")):null,
			name: this.state.name ? this.state.name :( localStorage.getItem("nameLibrary")?JSON.parse(localStorage.getItem("nameLibrary")):""),
			Ranking: this.state.Ranking.length ?this.state.Ranking : ( localStorage.getItem("rankingLibrary")?JSON.parse(localStorage.getItem("rankingLibrary")):[]),
			category: this.state.category?this.state.category:( localStorage.getItem("categoryLibrary")?JSON.parse(localStorage.getItem("categoryLibrary")):""),
