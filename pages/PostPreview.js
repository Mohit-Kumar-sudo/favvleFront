...
class PostPreview extends React.Component {
      ...
      axios
        ...
        .then((response) => {
          ...
          if (response.data.status) {
            ...
            console.log(process.env.NEXT_PUBLIC_FRONTEND_URL + `/Share/${response.data.rank._id}`)
            this.setState({
              shareurl: process.env.NEXT_PUBLIC_FRONTEND_URL + `/Share/${response.data.rank._id}`,
        ...
        (obj) => {
          if (!obj.error) {
            ...
            axios
              ...
              .then((response) => {
                this.setState({shareurl:process.env.NEXT_PUBLIC_FRONTEND_URL + `/Share/${this.state.ranking?._id}`});
  ...
  render() {
    console.log("Share Url",this.state.shareurl)
    return (
