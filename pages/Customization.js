...
class Customization extends React.Component {
  ...
  componentDidMount() {
    window.scrollTo(0, 0);
    this.setState({
      _id: localStorage?.getItem("idLibrary")
        ? JSON.parse(localStorage.getItem("idLibrary"))
        : null,
      name: this.state.name
        ? this.state.name
        : localStorage.getItem("nameLibrary")
        ? JSON.parse(localStorage.getItem("nameLibrary"))
        : "",
      ranking: this.state.ranking.length
        ? this.state.ranking
        : localStorage.getItem("rankingLibrary")
        ? JSON.parse(localStorage.getItem("rankingLibrary"))
        : [],
